...
import it.uniroma1.fabbricasemantica.servlet.WordNetHelper;
...
public class StandardDataProvider implements DataProvider<String> {
	private WordNetHelper wh;
	private List<String> data;
	private String myAnnotationWord;
	
	@Override 
	public String getData(Task task) {
		wh = new WordNetHelper();
		data=wh.trasnlationAnnotation();
		myAnnotationWord=wh.myAnnotation();
